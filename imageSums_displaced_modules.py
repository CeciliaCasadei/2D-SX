...
def imageSums():
    ...
    module_displacements_file = open('%s/module_displacements.pkl'%outputFolder, 'rb')
    ...
    for orbit in orbits:
        ...
        if not numpy.isnan(gauss_integral):
            refined_sigma_x = refined_sigma_x/(10**precision_factor) # Can be negative at this stage.

...
def shannonFit(myArguments):
    ...
    figureFolder = '%s/shannonFit_figures'%outputfolder
    ...
    for rod in rodIndices:
        ...
        experimental_dI = rodObject.experimental_dI # Finally unused
        qMin = rodObject.qMin
        qMax = rodObject.qMax
        ...
        matplotlib.pyplot.savefig('%s/shannon_rod_%d_%d_nPts_%d_defaultSigma.png'
                                   %(figureFolder, 
                                     rod[0], 
                                     rod[1], 
                                     n), dpi=96*2)
        ...
        rodObject.setModelCoefficients_error(perr)

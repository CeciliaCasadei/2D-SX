...
def makeOrbitsFunction(resolutionLimit):
    # BUILD RECIPROCAL LATTICE: h k qx qy resolution_2D q_2D
    cellSize = 62.45
    hmax = 100
    kmax = 100
    ...
    for reciprocalVector in reciprocalLattice:
        reciprocalVector_flagged = [reciprocalVector[0], 
                                    reciprocalVector[1], 
                                    reciprocalVector[2], 
                                    reciprocalVector[3], 
                                    reciprocalVector[4], 
    ...
    # CHECK
    #    print '%5d %5d %10.4f %10.4f %12.2f %8.3f %d'%(reciprocalVector_flagged[0], 
    #                                                   reciprocalVector_flagged[1], 
    #                                                   reciprocalVector_flagged[2], 
    #                                                   reciprocalVector_flagged[3], 
    #                                                   reciprocalVector_flagged[4], 
    #                                                   reciprocalVector_flagged[5],
    #                                                   reciprocalVector_flagged[6])
    #print len(reciprocalLattice_flagged)
    
    
    # BUILD ORBITS (SETS OF P3-RELATED SPOTS)
    orbits = []
    for reflection_i in reciprocalLattice_flagged:
        ...
        if flag == 1:
            ...
            for reflection_j in reciprocalLattice_flagged:
                if ((reflection_j[0] == -h-k and reflection_j[1] == h) or 
                    (reflection_j[0] == k    and reflection_j[1] == -h-k)):

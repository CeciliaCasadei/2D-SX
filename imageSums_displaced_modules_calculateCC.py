...
def calculateCC(myArguments):
    warnings.filterwarnings("ignore")
 
    # READ INPUTS    
    try:
        optionPairs, leftOver = getopt.getopt(myArguments, "h", ["selectedRun=", "cellSize="])
    except getopt.GetoptError:
        print 'python imageSums_displaced_modules_calculateCC.py --selectedRun <selectedRun> --cellSize <cellSize>'
        sys.exit(2)   
...
if __name__ == "__main__":
    print "\n**** CALLING imageSums_displaced_modules_calculateCC ****"
    calculateCC(sys.argv[1:])
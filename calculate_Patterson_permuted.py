...
def calculate_PattersonFunction(myArguments):
    ...
    matplotlib.pyplot.savefig('%s/intensitiesAtZero/permuted_real_reciprocalSpace.png'%inputFolder)
    ...
    myFigure.savefig("%s/intensitiesAtZero/permuted_measured_qx_qy_reciprocalLattice.png"%inputFolder, fontsize = 20)
    matplotlib.pyplot.close()
    ...
    myFigure.savefig("%s/intensitiesAtZero/permuted_measured_h_k_reciprocalLattice.png"%inputFolder, fontsize = 20)   
    matplotlib.pyplot.close()

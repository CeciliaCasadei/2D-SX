...
def calculate_PattersonFunction(myArguments):
    ...
    matplotlib.pyplot.savefig('%s/intensitiesAtZero/normalized_interpolated_IsAtZero.png'%inputFolder)
    matplotlib.pyplot.close()         
    ...
    matplotlib.pyplot.savefig('%s/intensitiesAtZero/normalized_interpolated_patterson.png'%inputFolder)
    matplotlib.pyplot.close()         
    ...
    matplotlib.pyplot.savefig('%s/intensitiesAtZero/normalized_interpolated_patterson_translated.png'%inputFolder)
    matplotlib.pyplot.close()         
    ...
    matplotlib.pyplot.savefig('%s/intensitiesAtZero/normalized_interpolated_unique_IsAtZero.png'%inputFolder)
    matplotlib.pyplot.close()
    
    
if __name__ == "__main__":
    print "\n**** CALLING calculate_Patterson_normalized ****"
